...
def cost_accuracy_plot():
    cost_accuracy_traditional_solver_data = np.load('../darcy/data/cost_accuracy_traditional_solver_data.npz', allow_pickle=True)   # 注意 allow_pickle=True
    ...
    cost_accuracy_mno_solver_data = np.load('../darcy/data/cost_accuracy_mno_solver_data.npz', allow_pickle=True)   # 注意 allow_pickle=True
    ...
    cost_accuracy_fno_solver_data = np.load('data/cost_accuracy_fno_solver_data.npz', allow_pickle=True)   # 注意 allow_pickle=True
